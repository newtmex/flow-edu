  ...
  42161: {
    ...
    ERC20Inbox: {
      ...
      abi: [
        {
          type: "constructor",
          inputs: [{ name: "_maxDataSize", type: "uint256", internalType: "uint256" }],
          stateMutability: "nonpayable",
        },
        {
          type: "function",
        ...
        },
        {
          ...
          name: "bridge",
          inputs: [],
          outputs: [{ name: "", type: "address", internalType: "contract IBridge" }],
          stateMutability: "view",
        },
        {
          type: "function",
          ...
          inputs: [
            { name: "dataLength", type: "uint256", internalType: "uint256" },
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "l2CallValue", type: "uint256", internalType: "uint256" },
            { name: "maxSubmissionCost", type: "uint256", internalType: "uint256" },
            { name: "excessFeeRefundAddress", type: "address", internalType: "address" },
            { name: "callValueRefundAddress", type: "address", internalType: "address" },
        ...
        },
        {
          ...
          name: "initialize",
          inputs: [
            { name: "_bridge", type: "address", internalType: "contract IBridge" },
            { name: "_sequencerInbox", type: "address", internalType: "contract ISequencerInbox" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        },
        {
          ...
          inputs: [{ name: "", type: "address", internalType: "contract IBridge" }],
          outputs: [],
          stateMutability: "nonpayable",
        },
        {
        ...
        },
        {
          type: "function",
          name: "sendL2Message",
          inputs: [{ name: "messageData", type: "bytes", internalType: "bytes" }],
          outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
          stateMutability: "nonpayable",
        },
        {
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "nonce", type: "uint256", internalType: "uint256" },
            { name: "value", type: "uint256", internalType: "uint256" },
            { name: "withdrawTo", type: "address", internalType: "address" },
          ],
          outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
          stateMutability: "nonpayable",
        },
        {
          ...
          name: "sequencerInbox",
          inputs: [],
          outputs: [{ name: "", type: "address", internalType: "contract ISequencerInbox" }],
          stateMutability: "view",
        },
        {
          type: "function",
        ...
        },
        {
          ...
          inputs: [{ name: "_allowListEnabled", type: "bool", internalType: "bool" }],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "val", type: "bool", indexed: false, internalType: "bool" },
          ],
          anonymous: false,
        },
        {
          ...
          inputs: [{ name: "isEnabled", type: "bool", indexed: false, internalType: "bool" }],
          anonymous: false,
        },
        {
          type: "event",
          ...
          inputs: [
            { name: "messageNum", type: "uint256", indexed: true, internalType: "uint256" },
        ...
        },
        {
          ...
          inputs: [{ name: "messageNum", type: "uint256", indexed: true, internalType: "uint256" }],
          anonymous: false,
        },
        {
          type: "event",
        ...
        { type: "error", name: "L1Forked", inputs: [] },
        {
          ...
          inputs: [{ name: "origin", type: "address", internalType: "address" }],
        },
        { type: "error", name: "NotCodelessOrigin", inputs: [] },
        { type: "error", name: "NotForked", inputs: [] },
        { type: "error", name: "NotOrigin", inputs: [] },
        {
          type: "error",
          name: "NotOwner",
          inputs: [
        ...
        },
        {
          ...
          inputs: [
            { name: "sender", type: "address", internalType: "address" },
            { name: "rollup", type: "address", internalType: "address" },
            { name: "owner", type: "address", internalType: "address" },
          ],
        },
        {
